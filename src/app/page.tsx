          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="text-center mb-24">
                <h2 className="font-serif-italic text-2xl text-slate-400 dark:text-zinc-500 mb-4">{t("home.methodology")}</h2>
                <h3 className="text-5xl md:text-6xl font-bold text-black dark:text-white">{t("home.problem_solution")}</h3>
              </div>
              <div className="relative">
                ...
                <div className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide lg:grid lg:grid-cols-4 gap-6 lg:gap-12 relative z-10 pb-8 lg:pb-0 -mx-6 px-6 lg:mx-0 lg:px-0">
                  <Step step="01" title={t("home.step01.title")} desc={t("home.step01.desc")} />
                  <Step step="02" title={t("home.step02.title")} desc={t("home.step02.desc")} />
                  <Step step="03" title={t("home.step03.title")} desc={t("home.step03.desc")} />
                  <Step step="04" title={t("home.step04.title")} desc={t("home.step04.desc")} />
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
            ...
            >
              ...
              <div className="order-1 lg:order-2">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-8 text-black dark:text-white tracking-tight">
                  ...
                  <span className="text-slate-400">{t("home.platform.title2")}</span>
                </h2>
            ...
            >
              <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                <div className="max-w-2xl">
                  <h2 className="font-serif-italic text-2xl text-slate-400 dark:text-zinc-500 mb-4">{t("home.ecosystem.badge")}</h2>
                  <h3 className="text-5xl md:text-6xl font-bold text-black dark:text-white tracking-tight">{t("home.ecosystem.title1")} <br /> <span className="text-slate-400 dark:text-zinc-500">{t("home.ecosystem.title2")}</span></h3>
                </div>
              ...
              <div className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 pb-8 md:pb-0 -mx-6 px-6 md:mx-0 md:px-0">
                <SectorCard href="/inmobiliarias" title={t("home.sector.inmo.title")} desc={t("home.sector.inmo.desc")} icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>} />
                <SectorCard href="/clinicas" title={t("home.sector.clinicas.title")} desc={t("home.sector.clinicas.desc")} icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>} />
                <SectorCard href="/restaurantes" title={t("home.sector.rest.title")} desc={t("home.sector.rest.desc")} icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>} />
                <SectorCard href="/gimnasios" title={t("home.sector.gym.title")} desc={t("home.sector.gym.desc")} icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>} />

                <ComingSoonCard title={t("home.sector.ecomm.title")} desc={t("home.sector.ecomm.desc")} icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>} />
                <ComingSoonCard title={t("home.sector.legal.title")} desc={t("home.sector.legal.desc")} icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>} />
                ...
                <div className="min-w-[85vw] snap-center md:min-w-0 p-8 rounded-[2.5rem] bg-black dark:bg-white text-white dark:text-black flex flex-col justify-center items-center text-center transition-colors duration-300">
                  <h4 className="text-xl font-bold mb-3">{t("home.sector.custom.title")}</h4>
                  <p className="text-white/40 dark:text-black/40 text-xs mb-8">{t("home.sector.custom.desc")}</p>
                  <Link href="/contacto" className="px-6 py-3 bg-white dark:bg-black text-black dark:text-white rounded-full text-xs font-bold btn-hover">{t("home.sector.custom.cta")}</Link>
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
...
function Step({ step, title, desc }: { step: string; title: string; desc: string }) {
  ...
  return (
    <div className="min-w-[85vw] snap-center lg:min-w-0 bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-slate-100 dark:border-white/5 shadow-xl shadow-slate-200/20 dark:shadow-none transition-colors duration-300">
      <div className="text-xs font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-6">{language === "es" ? "Paso" : "Step"} {step}</div>
  ...
  return (
    <Link href={href} className="min-w-[85vw] snap-center md:min-w-0 group p-8 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-100 dark:border-white/5 hover:border-black dark:hover:border-white transition-all duration-500 hover:shadow-2xl hover:shadow-black/5">
      ...
      <span className="text-xs font-bold uppercase tracking-widest text-black dark:text-white flex items-center transition-all">
        {language === "es" ? "Ver solución" : "See solution"} <svg className="w-3 h-3 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
      </span>
    </Link>
  );
}
  ...
  return (
    <div className="min-w-[85vw] snap-center md:min-w-0 relative group p-8 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-100 dark:border-white/5 overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-20">
        <span className="px-4 py-2 bg-black/5 dark:bg-white/5 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] text-black/40 dark:text-white/40">
