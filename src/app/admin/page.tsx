  ...
  return (
    <div className="space-y-12">
      <header className="flex justify-between items-end">
        <div>
          <h1 className="text-4xl font-bold text-black dark:text-white tracking-tight">Bienvenido de nuevo.</h1>
          <p className="text-slate-500 dark:text-zinc-500 mt-2">Aquí tienes un resumen de lo que está pasando en Synora.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <StatItem title="Post Publicados" value="12" icon={<svg className="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>} />
        <StatItem title="Borradores" value="4" icon={<svg className="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>} />
        <StatItem title="Visitas Totales" value="1.2k" icon={<svg className="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>} />
      </div>

      {/* Recent Activity Section */}
      <section className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-white/5 rounded-[2.5rem] p-10">
        <h2 className="text-2xl font-bold text-black dark:text-white mb-8">Últimos Posts</h2>
        <div className="space-y-0">
          <PostRow title="Cómo la IA está transformando las inmobiliarias" date="hace 2 días" status="Publicado" />
          <PostRow title="5 flujos de trabajo que deberías automatizar hoy" date="hace 4 días" status="Borrador" />
          <PostRow title="Guía completa: Synora y n8n Enterprise" date="hace 1 semana" status="Publicado" />
        </div>
      </section>
    </div>
  );
